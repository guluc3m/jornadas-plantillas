...
\title{Demo} % Título de la presentación
\subtitle{Basada en la demo de introducción a Beamer de ShareLaTeX.com y el tema Simple por Facundo Muñoz} % Subtítulo
\author{GUL} % Autor de la presentación
\twitter{guluc3m} % Twitter
...
\begin{frame}
    \frametitle{Tabla de contenidos} % Título de la diapositiva con el índice de contenidos
    \tableofcontents
\end{frame}
